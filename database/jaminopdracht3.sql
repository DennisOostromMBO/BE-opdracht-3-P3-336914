...
-- Database: jamin_b
--
DROP DATABASE IF EXISTS jaminopdracht2;
CREATE DATABASE IF NOT EXISTS jaminopdracht2 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE jaminopdracht2;
...
-- Stap 1: Verwijder beide tabellen indien ze al bestaan
DROP TABLE IF EXISTS Leverancier;
DROP TABLE IF EXISTS Contact;

-- Stap 2: Maak de Contact-tabel
...
-- Stap 3: Vul de Contact-tabel met data
INSERT INTO Contact
(
     Straat,
     Huisnummer,
...
VALUES
    ('Van Gilslaan', '34', '1045CB', 'Hilvarenbeek', SYSDATE(6), SYSDATE(6)),
    ('Den Dolderpad', '2', '1067RC', 'Utrecht', SYSDATE(6), SYSDATE(6)),
    ('Fredo Raalteweg', '257', '1236OP', 'Nijmegen', SYSDATE(6), SYSDATE(6)),
    ('Bertrand Russellhof', '21', '2034AP', 'Den Haag', SYSDATE(6), SYSDATE(6)),
    ('Leon van Bonstraat', '213', '145XC', 'Lunteren', SYSDATE(6), SYSDATE(6)),
    ('Bea van Lingenlaan', '234', '2197FG', 'Sint Pancras', SYSDATE(6), SYSDATE(6));

-- Stap 4: Maak de Leverancier-tabel
CREATE TABLE IF NOT EXISTS Leverancier (
     ...
     CONSTRAINT         FK_Leverancier_Contact FOREIGN KEY (ContactId)
...
VALUES
    ('Venco', 'Bert van Linge', 'L1029384719', '06-28493827', 1, NULL, 1, SYSDATE(6), SYSDATE(6)),
    ('Astra Sweets', 'Jasper del Monte', 'L1029284315', '06-39398734', 1, NULL, 2, SYSDATE(6), SYSDATE(6)),
    ('Haribo', 'Sven Stalman', 'L1029324748', '06-24383291', 1, NULL, 3, SYSDATE(6), SYSDATE(6)),
    ('Basset', 'Joyce Stelterberg', 'L1023845773', '06-48293823', 1, NULL, 4, SYSDATE(6), SYSDATE(6)),
    ('De Bron', 'Remco Veenstra', 'L1023857736', '06-34291234', 1, NULL, 5, SYSDATE(6), SYSDATE(6)),
    ('Quality Street', 'Johan Nooij', 'L1029234586', '06-23458456', 1, NULL, 6, SYSDATE(6), SYSDATE(6));
